...
Good architecture (Hexagonal, CQRS, DDD) pays dividends as codebases grow. Catalyst PSA hit 320,000 lines and remained maintainable because we invested in architecture early.

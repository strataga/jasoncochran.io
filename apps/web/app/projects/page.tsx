...
const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'wellos',
    description: 'The Operating System for Upstream Oil & Gas Operators — real-time SCADA monitoring, production tracking, predictive maintenance, ESG compliance, and offline-first field data capture for Permian Basin operators.',
    architectureHighlights: [
      'Six integrated applications across web, mobile, and desktop',
      'Multi-tenant SaaS with database-per-tenant isolation',
      'Offline-first field data capture with conflict resolution',
      'Real-time SCADA integration and predictive maintenance',
    ],
    techStack: ['Rust', 'Next.js 15', 'React Native', 'Electron', 'PostgreSQL', 'Redis'],
    accentColor: 'red',
    hasCaseStudy: true,
  },
  {
    ...
    description: 'Professional Services Automation platform for project management, resource allocation, time tracking, and financial management — built with hexagonal architecture for scale and maintainability.',
    architectureHighlights: [
      'Hexagonal architecture (ports & adapters) across 61 documented patterns',
      'Multi-tenant PSA for professional services firms',
      'NestJS + Prisma backend with PostgreSQL',
      'Next.js frontend with modern state management',
    ],
    techStack: ['Next.js', 'NestJS', 'TypeScript', 'PostgreSQL', 'Prisma', 'Node.js'],
    accentColor: 'yellow',
    hasCaseStudy: true,
  },
]

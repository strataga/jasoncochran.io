...
export const metadata: Metadata = {
  ...
  description: '28 years of experience building exceptional web and mobile applications. Expert in React, Next.js, Node.js, NestJS, and modern web technologies.',
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.7)' }}>
                  Software Engineer with 28 years of experience building exceptional web and mobile applications.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-4 uppercase tracking-wide" style={{
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <a href="/" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Home
                    </a>
                  </li>
                  <li>
                    <a href="/resume" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Resume
                    </a>
                  </li>
                  <li>
                    <a href="/projects" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Projects
                    </a>
                  </li>
                  <li>
                    <a href="https://blog.jasoncochran.io" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Blog
                    </a>
                  </li>
                  <li>
                    <a href="/certifications" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Certifications
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm">
                  <li>
                    <a href="mailto:jason.cochran@strataga.io" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                  ...
                  <li>
                    <a href="tel:+14322607580" className="hover:text-yellow-300 transition-colors" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      (432) 260-7580
                    </a>
                  </li>
